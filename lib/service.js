...
AzureMediaService.prototype.createFile = function (name, ParentAssetId, data, cb) {
  // var params = { id: fileId }

  var properties = {
    Name: name,
    ParentAssetId: ParentAssetId,
    ContentFileSize: data.ContentFileSize,
    MimeType: data.MimeType,
    IsPrimary: data.IsPrimary,
    IsEncrypted: data.IsEncrypted
  }

  return this.request.post('Files', properties, cb)
}

AzureMediaService.prototype.deleteFile = function (fileId, cb) {
  return this.request.delete('Files', fileId, cb)
}
